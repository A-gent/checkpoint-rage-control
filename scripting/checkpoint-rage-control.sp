...
public OnPluginStart()
{
	...
	new Handle:cvar = CreateConVar("l4d2_frustration_tickdown_in_saferoom", "0", "Enable tank frustration to tick down while the survivors are in saferoom");
	HookConVarChange(cvar, OnCvarChange);
	// In case the cvar existed before we booted.
